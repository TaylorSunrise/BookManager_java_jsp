...
//	String sql="insert into books(iid,aid,name,credate,status,note,imagepath) values(?,?,?,?,?,?,?)";
	...
	public String toString() {
		...
		return "book [bid="+bid+",name="+name+",author="+author+",publish="+publish+",creadate="+creadate+",status="
		+status+",note="+note+",item="+item.getName()+",admin="+admin.getUsername()+",imagepath="+imagepath+"]";
	}
